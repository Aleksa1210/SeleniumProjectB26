...
public class CydeoPracticePage {
    ...
    @FindBy (id = "draggable")
   // WebElement small = Driver.getDriver().findElement(By.id("draggable")); - this was utilities
    ...
    public CydeoPracticePage() {
        ...
        PageFactory.initElements(Driver.getDriver(),this); // PageFactory come from selenuim, this for utilities
    }
}
