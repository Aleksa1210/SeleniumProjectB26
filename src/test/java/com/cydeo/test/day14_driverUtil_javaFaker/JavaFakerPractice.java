...
public class JavaFakerPractice {
    ...
    public void java_faker_test(){
        ...
        System.out.println("faker.bothify(\"##??##-###??-????##\") = " + faker.bothify("##??##-###??-????##")); // # - number, ? - letter
        System.out.println("faker.chuckNorris() = " + faker.chuckNorris());
        System.out.println("faker.chuckNorris().fact() = " + faker.chuckNorris().fact());
        System.out.println("faker.chuckNorris().fact().replaceAll(\"Chuck Norris\", \"Aleksa\") = " + faker.chuckNorris().fact().replaceAll("Chuck Norris", "Aleksa"));
